        ...
        var transactionsReducer = function transactionsReducer() {
          ...
          switch (action.type) {
            case "transactions/addTransaction":
              newTransactionsForCategory = [].concat(
                _toConsumableArray(state[action.payload.category].slice()),
                [action.payload]
              );
            ...
            case "transactions/deleteTransaction":
              var deletedIndex = state[action.payload.category].findIndex(
                function (transaction) {
                  return transaction.id === action.payload.id;
                }
              );
              newTransactionsForCategory = state[
                action.payload.category
